...
return [
    ...
    | kelas validator. Beberapa aturan memilikit beberapa versi seperti
    | aturan size. Silakan ubah pesan ini sesuai kebutuhan Anda.
    |
    */
    ...
    | menggunakan konvensi "attribute.rule" untuk menamai baris. Ini dapat
    | digunakan untuk menentukan pesan bahasa kustom yang spesifik untuk
    ...
    */
    ...
    | dengan sesuatu yang lebih ramah pembaca sehingga pesan lebih ekspresif.
    |
    */
