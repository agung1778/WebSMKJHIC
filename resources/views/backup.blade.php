...
@section('content')
    ...
    <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Kami Memiliki Solusi Cerdas untuk Pendidikan Anda
    </h2>
        ...
        <div class="grid grid-cols-3 grid-rows-3 gap-4 h-96">
            ...
            @php
                ...
                $stats = [
                    ...
                    ['icon' => 'fa-graduation-cap', 'number' => 'A+', 'label' => 'Akreditasi Unggul'],
                ];
            @endphp
            {{-- SECTION STATS BAR --}}
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div class="text-left">
                            ...
                            <p class="mt-6 text-gray-600 leading-relaxed">
                                Kami bekerja sama dengan pemimpin industri untuk memberikan pengalaman nyata kepada siswa
                                melalui magang, kunjungan industri, pelatihan, dan peluang karier setelah lulus.
                            </p>
            ...
            <section class="py-16 sm:py-24 fade-in-section" style="background-color: {{ $amaliahDark }};">
                <div x-data="{
                    ...
                    {{-- Header Section --}}
                    <div class="text-center">
                        <h2 class="text-3xl md:text-4xl font-bold text-white">Kompetensi Keahlian</h2>
                    ...
                    <div class="mt-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
                       ...
                       <div x-ref="slider"
    class="lg:col-span-3 flex space-x-8 overflow-x-auto snap-x snap-mandatory scroll-smooth scrollbar-hide pb-4 
           px-4 lg:-mx-4">
                ...
                <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-gray-500">
                            Baca berita terbaru kami, dan ketahui tentang SMK Amaliah
                        </p>
                    </div>
            ...
            <section class="bg-[#ffffff] py-16 sm:py-24 mt-[-45px] fade-in-section">
                <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="max-w-3xl mx-auto text-center mt-[-30px]">
                        ...
                        <p class="mt-4 text-lg text-gray-600">
                            Tonton video di bawah ini untuk mengenal nilai-nilai, misi, dan orang-orang di balik
                            kesuksesan kami.
                        </p>
                    </div>
            ...
            <section class="py-16 sm:py-24" style="background-color: {{ $amaliahDark }}; fade-in-section">
                ...
                <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-gray-400">Kenali Fasilitas SMK Amaliah 1 &amp; 2</p>
                        <div class="w-24 h-px bg-gray-600 mx-auto mt-4"></div>
                    </div>
            ...
            <section class="bg-white py-16 sm:py-24 space-y-20 fade-in-section">
                ...
                <div>
                    ...
                    <div class="text-center">
                        <h2 class="text-3xl md:text-4xl font-bold" style="color: {{ $amaliahDark }};">
                            Postingan Instagram Terbaru Kami
                        </h2>
                        <div class="flex items-center justify-center gap-x-2 mx-auto mt-4">
