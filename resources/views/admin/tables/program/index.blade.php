                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @forelse($programs as $program)
                                <tr class="border-b border-gray-200 hover:bg-gray-100 transition-colors duration-200">
                                    <td class="py-4 px-6 text-left font-medium">{{ $program->name }}</td>
                                    ...
                                    <td class="py-4 px-6 text-left">{{ $program->publisher }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="py-8 text-center text-gray-500">Belum ada program sekolah yang
                                        ditambahkan.</td>
                                </tr>
                            @endforelse
                        </tbody>
