...
@section('content')
    ...
    <head>
        ...
        <title>Edit Program Sekolah</title>
        ...
        <div class="main-content flex-1 p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-[#292929]">Edit Program Sekolah</h1>
                ...
                <form action="{{ route('admin.programs.update', $program->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Program</label>
                    ...
                    <div class="mb-4">
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Gambar Program</label>
                        ...
                        @if($program->image)
                            ...
                            <img src="{{ asset('storage/' . $program->image) }}" alt="Gambar Program"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="5"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6CF600] @error('description') border-red-500 @enderror">{{ old('description', $program->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
