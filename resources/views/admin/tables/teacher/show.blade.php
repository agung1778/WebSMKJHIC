        ...
        <div class="main-content flex-1 p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-[#292929]">Detail Guru</h1>
                ...
                <div class="flex flex-col items-center justify-center mb-6">
                    ...
                    @else
                        <div
                            class="w-48 h-48 rounded-full bg-gray-300 flex items-center justify-center text-gray-500 shadow-md">
                ...
                <div class="prose max-w-none text-gray-700">
                    <h2 class="text-lg font-semibold text-[#292929]">Informasi Guru</h2>
                    ...
                    <p><strong>Sekolah Mengajar:</strong> {{ $teacher->school }}</p>
                    <p><strong>Kategori Pelajaran:</strong> {{ $teacher->category }}</p>
                </div>
