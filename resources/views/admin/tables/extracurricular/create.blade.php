        ...
        <div class="main-content flex-1 p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-[#292929]">Tambah Ekstrakurikuler</h1>
                ...
                <form action="{{ route('admin.extracurriculars.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="type" id="type"
                            ...
                            <option value="Wajib" @if(old('type') == 'Wajib') selected @endif>Wajib</option>
                            <option value="Pilihan" @if(old('type') == 'Pilihan') selected @endif>Pilihan</option>
                        </select>
                        @error('type')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
