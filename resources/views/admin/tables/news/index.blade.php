        ...
        <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
            ...
            <div class="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center space-x-4 border border-gray-200 sm:col-span-1 lg:col-span-3">
                    <div class="bg-[#e2ffc7] text-[#6CF600] rounded-full h-12 w-12 flex items-center justify-center flex-shrink-0">
            ...
            <div class="overflow-x-auto rounded-lg">
                <table class="w-full table-fixed border-collapse">
                    ...
                    <tbody class="text-gray-600 text-sm font-light" id="newsTableBody">
                        ...
                        @empty
                            <tr id="no-data">
                                <td colspan="7" class="py-8 text-center text-gray-500">Belum ada berita yang ditambahkan.
                                </td>
                            </tr>
                        @endforelse
