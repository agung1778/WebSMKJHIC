            ...
            <div class="max-w-screen-xl mx-auto flex items-center justify-center gap-x-14 px-4 h-12">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute dropdown-content bg-white shadow-lg mt-2 rounded-md py-1 w-48 z-10">
                        ...
                        <a href="#"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-[#59E300]">Foundation</a>
                        ...
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-[#59E300]">School
                            Life</a>
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-[#59E300]">Teacher
                            & Staff</a>
                ...
                <div class="relative group">
                    ...
                    <div class="absolute dropdown-content bg-white shadow-lg mt-2 rounded-md py-1 w-48 z-10">
                        <a href="{{ route('public.majors.index') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-[#59E300]">SMK
                            Amaliah 1</a>
                        <a href="{{ route('public.majors.index') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-[#59E300]">SMK
                            Amaliah 2</a>
                ...
                <div class="relative group">
                    <button class="nav-link"><a href="{{ route('public.facilities.index') }}">Facilities</a></button>
                </div>
                <div class="relative group">
                    <button class="nav-link">Help Center<i class="fa-solid fa-chevron-down ml-1.5 text-xs"></i></button>
                    <div class="absolute dropdown-content bg-white shadow-lg mt-2 rounded-md py-1 w-48 z-10">
                        <a href="#"
                        ...
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-[#59E300]">Contact
                            Us</a>
