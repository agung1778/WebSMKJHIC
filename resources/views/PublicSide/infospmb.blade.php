...
@section('content')
                ...
                <div class="lg:col-span-5 flex flex-col gap-6 w-full mt-10 lg:mt-0">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-t-4" style="border-color: {{ $amaliahGreen }};">
                        ...
                        <div class="relative w-full aspect-video rounded-xl overflow-hidden bg-gray-50 border border-gray-100 cursor-pointer group flex items-center justify-center p-2"
                            id="btn-buka-brosur">
                            <img src="{{ $spmbSetting && $spmbSetting->brochure_image_1 ? img_url($spmbSetting->brochure_image_1, 600, 900) : asset('assets/image/Brosur.jpeg') }}" width="600" height="900" loading="lazy"
    ...
    <div id="brosur-modal"
        ...
        <div class="relative w-full h-full flex items-center justify-center">
            <img src="{{ $spmbSetting && $spmbSetting->brochure_full_image ? img_url($spmbSetting->brochure_full_image, 600, 900) : asset('assets/image/brosur-spmb-full.jpg') }}" width="600" height="900" loading="lazy"
